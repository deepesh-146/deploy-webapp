    ...
    deletePartyById() {
        if (this.isdeletedParty) {
            ...
            this.partyService.deletePartyById({}, this.partyId).then((res) => {
                ...
                this.toastService.toastMsg({
                    title: "Success",
                    content: "Vendor Archived Successfully!!!",
                });
