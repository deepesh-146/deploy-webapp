(function () {
  ...
  (self["webpackChunkweb_app"] = self["webpackChunkweb_app"] || []).push([["src_app_pages_assets-module_assets-module_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _AssetsServiceService = /*#__PURE__*/function () {
        ...
        _createClass(_AssetsServiceService, [{
          ...
          value: function getNONCurrentAssetsData(data, userId) {
            var _this2 = this;

            return new Promise(function (resolve, reject) {
              _this2.httpClient.inventory(data, src_app_helpers_url_constants__WEBPACK_IMPORTED_MODULE_0__.UrlConstants.nonCurrentAsset + userId, 'GET').subscribe(function (res) {
                return resolve(res);
              }, function (err) {
                return reject(err);
              });
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function AssetEditFormcompoennetComponent_mat_error_22_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AssetEditFormcompoennetComponent_mat_error_31_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error", 20);
      ...
      function AssetEditFormcompoennetComponent_mat_option_40_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AssetEditFormcompoennetComponent_mat_error_41_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error", 20);
      ...
      function AssetEditFormcompoennetComponent_mat_error_50_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error", 20);
      ...
      var _AssetEditFormcompoennetComponent = /*#__PURE__*/function () {
        function _AssetEditFormcompoennetComponent(dialogRef, formBuilder, router, toastService, titleCasePipe, assetsServiceService) {
        ...
        _createClass(_AssetEditFormcompoennetComponent, [{
          ...
          value: function getASSETData() {
            ...
            this.assetsServiceService.getAsseTListByledger({}, this.currentUser.id).then(function (res) {
              ...
              _this6.GLData = res.data.map(function (item) {
      ...
      _AssetEditFormcompoennetComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        template: function AssetEditFormcompoennetComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function AssetEditFormcompoennetComponent_Template_button_click_4_listener() {
              return ctx.cancel();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function AssetEditFormcompoennetComponent_Template_button_click_6_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function AssetEditFormcompoennetComponent_Template_input_click_18_listener() {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _AssetFormcompoennetComponent = /*#__PURE__*/function () {
        ...
        _createClass(_AssetFormcompoennetComponent, [{
          ...
          value: function getASSETData() {
            ...
            this.assetsServiceService.getAsseTListByledger({}, this.currentUser.id).then(function (res) {
              console.log("AssetsByLedegr", res);
              _this7.GLData = res.data.map(function (item) {
                return item.glNumber;
              });
            });
          }
          ...
          value: function postAssetsDetails() {
            ...
            if (this.assetsForm.invalid) {
              ...
              this.assetsServiceService.addAssets(Body).then(function (res) {
                _this8.toastService.openSnackBar("Current Assets Added Successfully!!!");

                _this8.assetsServiceService.notifyassetsAdded();
          ...
          value: function openDatepicker() {
            // Check if the current value of taskdate is an "Invalid Date"
            var selectedDate = this.assetsForm.get('assetDate').value;
      ...
      _AssetFormcompoennetComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        decls: 41,
        vars: 9,
        consts: [[1, "modal-header", "pt-0"], [1, "modal-title", "mb-0", 2, "color", "#EB8B3F", "font-weight", "500", "margin-left", "10px"], [1, "addProductButtons"], ["type", "button", 1, "btn", "btn-cancel", 2, "margin-right", "10px !important", 3, "click"], ["type", "submit", 1, "btn", "btn-save", 3, "click"], [1, "modal-body"], [1, "container-fluid", "px-2"], [3, "formGroup"], [1, "row"], [1, "col-md-6", "col-sm-12", "col-lg-6", "col-xl-6"], [1, "form-label"], [1, "error-asterisk"], ["appearance", "outline", 1, "example-full-width"], ["matInput", "", "required", "", "ngModel", "", "bsDatepicker", "", "placeholder", "DD MMM YYYY", "id", "datePicker", "bsDatepicker", "", "formControlName", "assetDate", "autocomplete", "off", 2, "text-transform", "uppercase!important", 3, "bsConfig", "click"], [1, "iconcalender"], ["class", "text-danger", 4, "ngIf"], ["matInput", "", "required", "", "matNativeControl", "", "matInput", "", "disableOptionCentering", "", "placeholder", "Assets Name", "formControlName", "assetName", 3, "ngClass"], ["matNativeControl", "", "type", "text", "placeholder", "Amount", "formControlName", "toatalAmount"], [1, "text-danger"]],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function AssetListcompoennetComponent_tr_26_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function AssetListcompoennetComponent_tr_26_Template_button_click_14_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r5);

            var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"]();

            return ctx_r4.openEditModel();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function AssetListcompoennetComponent_tr_26_Template_span_click_17_listener() {
            ...
            return ctx_r6.getcurrentAssetsId(item_r3.id);
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate1"]("\u20B9\xA0", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind2"](11, 8, item_r3.valueOfAsset, "1.2-2"), "");
        }
      }

      function AssetListcompoennetComponent_tbody_27_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AssetListcompoennetComponent_mat_paginator_28_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("page", function AssetListcompoennetComponent_mat_paginator_28_Template_mat_paginator_page_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r8);

            var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"]();

            return ctx_r7.handlePage($event);
          });
      ...
      var _AssetListcompoennetComponent = /*#__PURE__*/function () {
        function _AssetListcompoennetComponent(dialog, assetsServiceService, toastService, titleCasePipe) {
        ...
        _createClass(_AssetListcompoennetComponent, [{
          ...
          value: function getCurrentAssetsData() {
            ...
            this.assetsServiceService.getCurrentAssetsData({}, this.currentUser.id, this.partyPageSize, this.currentPageNo + 1).then(function (res) {
              console.log("res");
              _this10.AseetData = res.data.pageData;
          ...
          value: function deleteAsset() {
            ...
            this.assetsServiceService.deleteAssets({}, this.assetId).then(function (res) {
              _this11.toastService.openSnackBar("Current Assets Deleted Successfully!!!");

              _this11.getCurrentAssetsData();
            }, function (err) {
              if (err.error.expose) {
      ...
      _AssetListcompoennetComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
        ...
        template: function AssetListcompoennetComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function AssetListcompoennetComponent_Template_button_click_4_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function AssetListcompoennetComponent_Template_a_click_43_listener() {
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.NgForOf, _angular_common__WEBPACK_IMPORTED_MODULE_6__.NgIf, _angular_material_paginator__WEBPACK_IMPORTED_MODULE_7__.MatPaginator],
        pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.UpperCasePipe, _angular_common__WEBPACK_IMPORTED_MODULE_6__.DatePipe, _angular_common__WEBPACK_IMPORTED_MODULE_6__.DecimalPipe],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function AssetNonFormcompoennetComponent_ng_container_78_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AssetNonFormcompoennetComponent_ng_container_78_Template_button_click_9_listener() {
            ...
            return ctx_r14.deleteaddAddtionalDetails(group_r10);
          });
      ...
      function AssetNonFormcompoennetComponent_div_109_mat_option_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AssetNonFormcompoennetComponent_div_109_mat_option_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AssetNonFormcompoennetComponent_div_109_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AssetNonFormcompoennetComponent_div_110_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 9);
      ...
      function AssetNonFormcompoennetComponent_div_111_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 9);
      ...
      function AssetNonFormcompoennetComponent_div_113_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 9);
        ...
        _createClass(_AssetNonFormcompoennetComponent, [{
          ...
          value: function createnonAseetsForm() {
            ...
            this.additionalDetailsControls.valueChanges.subscribe(function (data) {
              _this12.toatalAmount = data.reduce(function (a, b) {
                return a + +b.assetsAmount;
              }, 0);

              _this12.updateTotalCostOfAssets();
          ...
          value: function getASSETData() {
            ...
            this.assetsServiceService.getAsseTListByledger({}, this.currentUser.id).then(function (res) {
              console.log("AssetsByLedegr", res);
              _this13.GLData = res.data.map(function (item) {
                return item.glNumber;
              });
            });
          }
          ...
          value: function postnonAsseTsForm() {
            ...
            if (this.nonAssetsForm.invalid) {
              ...
              this.assetsServiceService.addAssets(Body).then(function (res) {
                _this14.toastService.openSnackBar("Non Current Assets Added Successfully!!!");

                _this14.assetsServiceService.notifyassetsAdded();
      ...
      _AssetNonFormcompoennetComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        ...
        template: function AssetNonFormcompoennetComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("change", function AssetNonFormcompoennetComponent_Template_input_change_91_listener($event) {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_core_services_assets_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/core/services/assets-service.service */
      93306);
      /* harmony import */
      ...
      function AssetNonListcompoennetComponent_tr_28_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AssetNonListcompoennetComponent_tr_28_Template_button_click_20_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r4);

            var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"]();

            return ctx_r3.openEditModel();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AssetNonListcompoennetComponent_tr_28_Template_span_click_23_listener() {
            ...
            return ctx_r5.getAssetsId(item_r2.id);
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"](" \u20B9\xA0", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind2"](11, 10, item_r2.valueOfAsset, "1.2-2"), "");

          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](3);

          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"]("\u20B9\xA0", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind2"](14, 13, ctx_r0.roundDepreciationValue(item_r2.Yearlydepreciation), "1.2-2"), "");

          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](3);

          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"](" \u20B9\xA0", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind2"](17, 16, item_r2.costOfAsset, "1.2-2"), "");
        }
      }

      function AssetNonListcompoennetComponent_tbody_29_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _AssetNonListcompoennetComponent = /*#__PURE__*/function () {
        function _AssetNonListcompoennetComponent(dialog, assetsServiceService, toastService, titleCasePipe) {
        ...
        _createClass(_AssetNonListcompoennetComponent, [{
          ...
          value: function getNonAssetData() {
            ...
            this.assetsServiceService.getNONCurrentAssetsData({}, this.currentUser.id).then(function (res) {
              _this17.NonAseetData = res.data.totalDecriptionValue;
            }, function (err) {
              if (err.error.expose || err.status == 404) {
                _this17.NonAseetData = [];
          ...
          value: function deleteAsset() {
            ...
            this.assetsServiceService.deleteAssets({}, this.aseetId).then(function (res) {
              _this18.toastService.openSnackBar("Non Current Assets Deleted Successfully!!!");

              _this18.getNonAssetData();
            }, function (err) {
              if (err.error.expose) {
      ...
      _AssetNonListcompoennetComponent.ɵfac = function AssetNonListcompoennetComponent_Factory(t) {
        return new (t || _AssetNonListcompoennetComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__.MatDialog), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](src_app_core_services_assets_service_service__WEBPACK_IMPORTED_MODULE_3__.AssetsServiceService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](src_app_core_services_toast_notification_service__WEBPACK_IMPORTED_MODULE_4__.ToastNotificationService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_7__.TitleCasePipe));
      };

      _AssetNonListcompoennetComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        type: _AssetNonListcompoennetComponent,
        selectors: [["app-asset-non-listcompoennet"]],
        decls: 46,
        vars: 2,
        consts: [[1, "row", "headerButtons"], [1, "flex-item", "searchBar"], ["type", "search", "id", "searchInput", "placeholder", "Assets Name", 1, "form-control", "pe-5", "my-2", "mx-0"], [1, "navOption-btns", "flex-item", "formButtons", "mx-0"], ["type", "button", 1, "btn", "text-nowrap", "my-2", 3, "click"], [1, "fas", "fa-plus", "me-2"], ["type", "button", 1, "btn", "text-nowrap", "my-2"], [1, "fas", "fa-download"], [2, "width", "100%", "overflow-x", "auto", "margin-top", "8px"], [1, "table", "table-responsive", "table-striped", "fs--1", "mb-0"], [1, "text-nowrap", 2, "vertical-align", "middle", "padding-bottom", "3px"], ["type", "checkbox"], [1, "text-nowrap", 2, "vertical-align", "middle"], [1, "text-nowrap", 2, "vertical-align", "middle", "text-align", "right"], ["class", "btn-reveal-trigger text-left ", "style", "color: #676398!important;", 4, "ngFor", "ngForOf"], [4, "ngIf"], ["id", "errorDelete-modal", "tabindex", "-1", "role", "dialog", "aria-hidden", "true", 1, "modal", "fade"], ["role", "document", 1, "modal-dialog", "modal-dialog-centered", 2, "max-width", "350px"], [1, "modal-content", "position-relative"], [1, "position-absolute", "top-0", "end-0", "mt-2", "me-2", "z-index-1"], ["data-bs-dismiss", "modal", "aria-label", "Close", 1, "btn-close", "btn", "btn-sm", "btn-circle", "d-flex", "flex-center", "transition-base"], [1, "modal-body", "p-0"], [1, "rounded-top-lg", "py-3", "ps-4", "pe-6", "bg-light"], ["id", "modalExampleDemoLabel", 1, "mb-1", "text-center", "font-weight-bold", 2, "font-weight", "800"], [1, "text-center"], [1, "modal-footer", "justify-content-center"], ["data-bs-dismiss", "modal", 1, "btn", "btn-outline-success"], ["data-bs-dismiss", "modal", 1, "btn", "btn-outline-danger", 3, "click"], [1, "btn-reveal-trigger", "text-left", 2, "color", "#676398!important"], [1, "text-nowrap", 2, "vertical-align", "middle", "margin-left", "100px !important", "padding-bottom", "3px"], [2, "vertical-align", "middle"], [2, "vertical-align", "middle", "text-align", "right"], [1, "text-nowrap", 2, "text-align", "right !important", "vertical-align", "middle"], [1, "flex"], [1, "btn", 3, "click"], ["data-bs-toggle", "tooltip", "data-bs-placement", "top", "title", "Edit", 1, "bi-pencil-square", "icon-color", "iconFontSize", "ps-2"], ["data-bs-toggle", "modal", "data-bs-target", "#errorDelete-modal", 1, "btn"], ["data-bs-toggle", "tooltip", "data-bs-placement", "top", "title", "Delete", 1, "bi-trash", "icon-color", "iconFontSize", "ps-2", 2, "color", "red", 3, "click"], ["colspan", "10"], ["src", "../../../assets/img/icons/spot-illustrations/notfound1.png", "alt", "notfound1", "width", "200", "height", "150", 1, "image-responsive"]],
        template: function AssetNonListcompoennetComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AssetNonListcompoennetComponent_Template_button_click_4_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AssetNonListcompoennetComponent_Template_button_click_7_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AssetNonListcompoennetComponent_Template_a_click_44_listener() {
              return ctx.deleteAsset();
            });
        ...
        pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.UpperCasePipe, _angular_common__WEBPACK_IMPORTED_MODULE_7__.DatePipe, _angular_common__WEBPACK_IMPORTED_MODULE_7__.DecimalPipe],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function NonAssetEditFormComponent_mat_error_21_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NonAssetEditFormComponent_mat_error_38_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error", 53);
      ...
      function NonAssetEditFormComponent_mat_error_46_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error", 53);
      ...
      function NonAssetEditFormComponent_mat_error_61_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error", 53);
      ...
      function NonAssetEditFormComponent_mat_option_69_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NonAssetEditFormComponent_mat_error_70_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error", 53);
      ...
      function NonAssetEditFormComponent_ng_container_88_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keyup.enter", function NonAssetEditFormComponent_ng_container_88_Template_input_keyup_enter_7_listener() {
            ...
            return ctx_r13.addAddtionalDetails();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function NonAssetEditFormComponent_ng_container_88_Template_button_click_9_listener() {
            ...
            return ctx_r15.deleteaddAddtionalDetails(group_r11);
          });
      ...
      function NonAssetEditFormComponent_div_119_mat_option_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NonAssetEditFormComponent_div_119_mat_option_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NonAssetEditFormComponent_div_119_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NonAssetEditFormComponent_div_120_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div", 9);
      ...
      function NonAssetEditFormComponent_div_122_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div", 9);
      ...
      var _NonAssetEditFormComponent = /*#__PURE__*/function () {
        function _NonAssetEditFormComponent(formBuilder, router, toastService, titleCasePipe, dialogRef, cdr, assetsServiceService) {
        ...
        _createClass(_NonAssetEditFormComponent, [{
          ...
          value: function createnonAseetsForm() {
            ...
            this.additionalDetailsControls.valueChanges.subscribe(function (data) {
              _this19.toatalAmount = data.reduce(function (a, b) {
                return a + +b.assetsAmount;
              }, 0);

              _this19.updateTotalCostOfAssets();
            }); // Subscribe to value changes of valueOfAssets control
          ...
          key: "updateTotalCostOfAssets",
          value: function updateTotalCostOfAssets() {
            var allTotal = this.toatalAmount + parseFloat(this.nonAssetsForm.get('valueOfAssets').value);
            console.log('allTotal value -->', allTotal);
          ...
          value: function getASSETData() {
            ...
            this.assetsServiceService.getAsseTListByledger({}, this.currentUser.id).then(function (res) {
              console.log("AssetsByLedegr", res);
              _this20.GLData = res.data.map(function (item) {
                return item.glNumber;
              });
            });
          }
      ...
      _NonAssetEditFormComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        template: function NonAssetEditFormComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function NonAssetEditFormComponent_Template_button_click_4_listener() {
              return ctx.cancel();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function NonAssetEditFormComponent_Template_button_click_6_listener() {
              return ctx.postnonAsseTsForm();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function NonAssetEditFormComponent_Template_input_click_26_listener() {
              return ctx.openDatepicker();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("change", function NonAssetEditFormComponent_Template_input_change_101_listener($event) {
              return ctx.documentChange($event);
            });
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _RunDepraciationComponentComponent = /*#__PURE__*/function () {
        function _RunDepraciationComponentComponent(dialogRef, formBuilder) {
        ...
        _createClass(_RunDepraciationComponentComponent, [{
          ...
          key: "createRunDepreciationForm",
          value: function createRunDepreciationForm() {
      ...
      _RunDepraciationComponentComponent.ɵfac = function RunDepraciationComponentComponent_Factory(t) {
        return new (t || _RunDepraciationComponentComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__.MatDialogRef), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_0__.FormBuilder));
      };

      _RunDepraciationComponentComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: _RunDepraciationComponentComponent,
        selectors: [["app-run-depraciation-component"]],
        decls: 24,
        vars: 1,
        consts: [[1, "modal-header", "pt-0"], [1, "modal-title", "mb-0", 2, "color", "#EB8B3F", "font-weight", "bolder"], [1, "addProductButtons"], ["type", "button", 1, "btn", "btn-cancel", 2, "margin-right", "10px !important", 3, "click"], ["type", "submit", 1, "btn", "btn-save", 3, "click"], [1, "modal-body"], [1, "container-fluid", "px-0"], [3, "formGroup"], [1, "flex-container"], [1, "flex-item", "form-label", "text-nowrap"], ["type", "radio", "formControlName", "depereceType", "value", "Monthly"], [1, "radio-label", "m-1"], ["type", "radio", "formControlName", "depereceType", "value", "Quaterly", 1, "radio-label"], ["type", "radio", "formControlName", "depereceType", "value", "Yearly", 1, "radio-label"]],
        template: function RunDepraciationComponentComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function RunDepraciationComponentComponent_Template_button_click_4_listener() {
              return ctx.cancel();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function RunDepraciationComponentComponent_Template_button_click_6_listener() {
              return ctx.saveRunDepraciation();
            });
