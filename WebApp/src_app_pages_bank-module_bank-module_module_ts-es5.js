          ...
          value: function calculateValues() {
            if (this.paymentType === undefined) {
              ...
              if (this.paymentType == "PAYMENT") {
                ...
                var _currentBalance = parseFloat(this.CashInHandForm.get('currentBal').value) || 0;

                var _newAmount = parseFloat(this.CashInHandForm.get('enterAmount').value) || 0;

                var _newBalance = Math.abs(_currentBalance - _newAmount);
      ...
      _AddCashComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        ...
        template: function AddCashComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("change", function AddCashComponent_Template_input_change_30_listener($event) {
