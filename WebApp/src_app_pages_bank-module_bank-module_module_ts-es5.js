(function () {
  ...
  (self["webpackChunkweb_app"] = self["webpackChunkweb_app"] || []).push([["src_app_pages_bank-module_bank-module_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function AddCashComponent_mat_error_44_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "mat-error", 28);
      ...
      var _AddCashComponent = /*#__PURE__*/function () {
        ...
        _createClass(_AddCashComponent, [{
          ...
          value: function calculateValues() {
            var currentBalance = parseFloat(this.CashInHandForm.get('currentBal').value) || 0;
            var newAmount = parseFloat(this.CashInHandForm.get('enterAmount').value) || 0;
            var newBalance = Math.abs(currentBalance + newAmount);
            this.CashInHandForm.patchValue({
          ...
          value: function GetpartyId(e) {
            ...
            if (e) {
              this.saleInvoiceService.getsaleInvoiceByIncoice({}, this.currentUser.id, e).then(function (res) {
                _this.partyId = res.data.pageData[0].partyId;
                _this.saleInvoiceId = res.data.pageData[0].id;
              });
            }
          }
        }, {
          ...
          value: function reduceMoney() {
            ...
            var enteredAmount = parseFloat(this.CashInHandForm.get('enterAmount').value) || 0;
          ...
          value: function cashSave() {
            ...
            if (this.CashInHandForm.invalid) {
              ...
              this.cashInHandService.cashInHandpost(body).then(function (res) {
                _this2.toastService.openSnackBar("Cash In Hand Updated");

                _this2.CashInHandForm.reset();

                _this2.submitted = false;

                _this2.dialogRef.close();

                _this2.getCurrentBal();
              }, function (err) {
                if (err.error.expose) {
          ...
          value: function getCurrentBal() {
            ...
            this.cashInHandService.getCurrentBalance({}, this.currentUser.id).then(function (res) {
              _this3.CashInHandForm.patchValue({
          ...
          value: function openDatepicker() {
            ...
            var selectedDate = this.CashInHandForm.get('date').value;
      ...
      _AddCashComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        ...
        decls: 55,
        vars: 8,
        consts: [[1, "modal-header", "pt-0"], [1, "modal-title", "mb-0", 2, "color", "#EB8B3F", "font-weight", "bolder"], [1, "addProductButtons"], ["type", "button", 1, "btn", "btn-cancel", 2, "margin-right", "10px !important", 3, "click"], ["type", "button", 1, "btn", "btn-save", 3, "click"], [1, "modal-body"], [1, "container-fluid", "px-2"], [3, "formGroup"], [1, "cashInHandButtons", "mb-5"], [1, "btn", "btn-add-cash", 3, "click"], [1, "fas", "fa-plus", "me-2"], [1, "btn", "btn-reduce-cash", 3, "click"], [1, "fas", "fa-minus", "me-2"], [1, "row"], [1, "col-sm-12", "col-md-12", "col-lg-6", "mb-3"], [1, "form-label"], ["appearance", "outline", 1, "example-full-width"], ["matInput", "", "placeholder", "Current Balance", "formControlName", "currentBal", 3, "change"], ["type", "text", "matInput", "", "placeholder", "Sale Invoice No", "formControlName", "saleInvoiceNo", 3, "change"], ["for", "Date", 1, "form-label"], ["matInput", "", "required", "", "ngModel", "", "bsDatepicker", "", "formControlName", "date", "placeholder", "Date", "id", "datePicker", "bsDatepicker", "", "autocomplete", "off", 2, "text-transform", "uppercase !important", 3, "ngModel", "bsConfig", "ngModelChange", "click"], [1, "iconcalender"], [1, "error-asterisk"], ["type", "number", "matInput", "", "placeholder", "Enter Amount", "formControlName", "enterAmount", "min", "0", "oninput", "this.value = Math.abs(this.value)", 3, "ngClass", "change"], ["class", "text-danger", 4, "ngIf"], [1, "col-sm-12", "col-md-12", "col-lg-12", "mb-3"], ["type", "number", "matInput", "", "placeholder", "New Balance", "formControlName", "NewBalance", "readonly", ""], ["matInput", "", "required", "", "rows", "3", "placeholder", "Enter Item Description", "formControlName", "formRemark"], [1, "text-danger"]],
        template: function AddCashComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](27, "mat-form-field", 16);

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](28, "input", 18);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](32, "mat-form-field", 16);
            ...
            })("click", function AddCashComponent_Template_input_click_33_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](38, "label", 15);

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](39, "New Amount");

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](40, "span", 22);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("change", function AddCashComponent_Template_input_change_43_listener() {
              return ctx.calculateValues();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](44, AddCashComponent_mat_error_44_Template, 2, 0, "mat-error", 24);

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](45, "div", 25);

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](46, "label", 15);

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](47, "New Balance");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](52, "Item Description");
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngModel", ctx.todaysDate)("bsConfig", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](5, _c0));

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](10);

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction1"](6, _c1, ctx.f1.enterAmount.invalid && ctx.f1.enterAmount.touched && ctx.submitted));
        ...
        styles: [".form-label[_ngcontent-%COMP%] {\n  margin-left: 5px;\n}\n\n.cashInHandButtons[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  margin: 0 4px;\n}\n\n.btn-reduce-cash[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  border: 1px solid #979797;\n  color: #000;\n  border-radius: 10px;\n  margin-left: 10px;\n  height: 35px !important;\n  white-space: nowrap;\n}\n\n.btn-reduce-cash[_ngcontent-%COMP%]:hover {\n  color: white;\n  background-color: #979797;\n}\n\n.btn-add-cash[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  border: 1px solid #fc7643;\n  color: #fc7643;\n  border-radius: 10px;\n  height: 35px !important;\n  white-space: nowrap;\n}\n\n.btn-add-cash[_ngcontent-%COMP%]:hover {\n  color: white;\n  background-color: #fc7643;\n}\n\n.iconcalender[_ngcontent-%COMP%] {\n  float: right !important;\n  margin-top: -22px !important;\n}\n\n.modal-header[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  margin: 0 10px;\n}\n\n.addProductButtons[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  margin-left: auto;\n}\n\n@media screen and (max-width: 992px) {\n  .modal-header[_ngcontent-%COMP%] {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n  }\n\n  .addProductButtons[_ngcontent-%COMP%] {\n    margin: 10px 0px;\n  }\n}\n\n@media screen and (max-width: 768px) {\n  .cashInHandButtons[_ngcontent-%COMP%] {\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
      });
      /***/
    },
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function BanKDetailsComponent_tbody_22_tr_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function BanKDetailsComponent_tbody_22_tr_1_Template_span_click_10_listener() {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r5);
            ...
            return ctx_r6.GetbankById(bankData_r2.accountNumber);
          });
      ...
      function BanKDetailsComponent_tbody_22_Template(rf, ctx) {
        if (rf & 1) {
        ...
        _createClass(_BanKDetailsComponent, [{
          ...
          value: function getbankdetails() {
            ...
            this.bankService.getBankDetails({}, this.currentUser.id).then(function (res) {
              _this5.bankApiResponse = res.data;

              _this5.bankApiResponse.forEach(function (ele) {
                ele.isEnable = false;
              });
            }, function (err) {
              if (err.error.expose) {
          ...
          value: function getbankdetailsById(id) {
            ...
            this.bankService.getBankDetailsById({}, this.currentUser.id, id).then(function (res) {
              _this6.singleBankRecord = res.data;
              _this6.singleBankName = _this6.singleBankRecord.bankName;
              _this6.singleBankAcc = _this6.singleBankRecord.accountNumber;
              _this6.singleIfscCode = _this6.singleBankRecord.ifscCode;
            });
          }
        }, {
          key: "deleteOfferById",
          value: function deleteOfferById() {
            var _this7 = this;

            this.bankService.deleteBankAccNo({}, this.accoutNumber).then(function (res) {
              _this7.toastService.openSnackBar("Bank Record Deleted Successfully!!!");

              _this7.getbankdetails();
            });
          }
        }, {
          key: "myClickHandler",
          ...
          key: "GetbankById",
          value: function GetbankById(offerId) {
      ...
      _BanKDetailsComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
        ...
        template: function BanKDetailsComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function BanKDetailsComponent_Template_button_click_3_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function BanKDetailsComponent_Template_button_click_6_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function BanKDetailsComponent_Template_a_click_135_listener() {
              return ctx.deleteOfferById();
            });
