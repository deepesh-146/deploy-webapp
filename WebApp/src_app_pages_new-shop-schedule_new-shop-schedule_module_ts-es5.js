(function () {
  ...
  (self["webpackChunkweb_app"] = self["webpackChunkweb_app"] || []).push([["src_app_pages_new-shop-schedule_new-shop-schedule_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _updateappointment_updateappointment_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./updateappointment/updateappointment.component */
      89154);
      /* harmony import */
      ...
      var src_app_core_services_schedule_appointment_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      function AppointmentPageComponent_span_14_button_1_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AppointmentPageComponent_span_14_button_1_span_1_Template_span_click_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r11);

            var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](3);

            return ctx_r10.upiCheckedId.length > 0 ? ctx_r10.getUPIcheckId($event, ctx_r10.upiCheckedId) : ctx_r10.getSingleCheckedId($event, ctx_r10.checkSingleArray);
          });
      ...
      function AppointmentPageComponent_span_14_button_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppointmentPageComponent_span_14_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppointmentPageComponent_tr_31_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("change", function AppointmentPageComponent_tr_31_Template_input_change_2_listener($event) {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r15);

            var appointment_r12 = restoredCtx.$implicit;

            var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"]();

            return ctx_r14.onChekedsingleCheck($event, appointment_r12.id);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AppointmentPageComponent_tr_31_Template_button_click_19_listener() {
            ...
            return ctx_r16.updateModal(appointment_r12.id);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AppointmentPageComponent_tr_31_Template_span_click_22_listener() {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r15);
            ...
            return ctx_r17.deleteAppointMent(appointment_r12.id);
          });
        ...
        if (rf & 2) {
          var appointment_r12 = ctx.$implicit;
      ...
      function AppointmentPageComponent_tbody_32_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppointmentPageComponent_mat_paginator_33_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("page", function AppointmentPageComponent_mat_paginator_33_Template_mat_paginator_page_0_listener($event) {
      ...
      function AppointmentPageComponent_h4_59_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppointmentPageComponent_h4_60_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "h4", 24);
      ...
      function AppointmentPageComponent_a_64_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AppointmentPageComponent_a_64_Template_a_click_0_listener() {
            ...
            return ctx_r20.deleteByAppointment();
          });
      ...
      function AppointmentPageComponent_a_65_Template(rf, ctx) {
        if (rf & 1) {
          var _r23 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "a", 27);

          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AppointmentPageComponent_a_65_Template_a_click_0_listener() {
            ...
            return ctx_r22.deleteByAppointment();
          });
      ...
      var _AppointmentPageComponent = /*#__PURE__*/function () {
        function _AppointmentPageComponent(dialog, ScheduleAppointmentService, route, toastService, commonService, titleCasePipe) {
        ...
        _createClass(_AppointmentPageComponent, [{
          ...
          value: function getAllAppointment() {
            ...
            this.ScheduleAppointmentService.getAllAppointMent({}, this.currentUser.id, this.appointmentPageSize, this.currentPageNo).then(function (res) {
              console.log(res.data);
              _this2.appointListRes = res.data.pageData;
              _this2.totalrow = res.data.totalrows; // this.totalPages = res.data.totalPages;

              _this2.currentPageNo = res.data.currentPage;
              _this2.toatlPages = res.data.totalPages;
            });
          }
        }, {
          key: "searchAppoint",
          value: function searchAppoint() {
            var _this3 = this;
            ...
            if (this.searchTerm.trim() === '') {
              ...
              this.ScheduleAppointmentService.getAllAppointMent({}, this.currentUser.id, this.appointmentPageSize, 1).then(function (res) {
                _this3.appointListRes = res.data.pageData;
                _this3.currentPageNo = res.data.currentPage;
              });
            } else {
              this.ScheduleAppointmentService.getAllAppointMent({}, this.currentUser.id, this.appointmentPageSize, this.currentPageNo).then(function (res) {
                console.log(res.data.pageData);
                _this3.appointListRes = res.data.pageData.filter(function (item) {
                  return (// item.scheduleName.toLowerCase().includes(this.searchTerm.toLowerCase()) ||
                    item.name.toLowerCase().includes(_this3.searchTerm.toLowerCase()) || item.locationType.toLowerCase().includes(_this3.searchTerm.toLowerCase()) // item.appointmentType.locationType.toLowerCase().includes(this.searchTerm.toLowerCase())

                  );
                });
                console.log(_this3.appointListRes);
              });
          ...
          value: function onChekMultiple($event) {
            ...
            this.upiCheckedId1 = this.appointListRes.map(function (item) {
              if (id == -1) {
                if (_this4.isChecked == true) {
                  _this4.archiveIconfalse = true;
                  _this4.checkSelectsinglefalse = true;
                  return item;
                } else {
                  _this4.archiveIconfalse = false;
                  _this4.checkSelectsinglefalse = false;
                  _this4.upiCheckedId = [];
                  _this4.upiCheckedId1 = [];
                }
              }
            });
          ...
          value: function onChekedsingleCheck(e, appointId) {
            if (e.target.checked) {
              this.upiCheckedId.push(appointId);
            } else {
              var index = this.upiCheckedId.indexOf(appointId);
          ...
          key: "getUPIcheckId",
          value: function getUPIcheckId(e, appointId) {
            this.appointId = appointId;
            console.log("this.appointId", this.appointId);
          }
        }, {
          key: "getSingleCheckedId",
          value: function getSingleCheckedId(e, appointId) {
            this.appointId = appointId;
          }
        }, {
          ...
          key: "deleteByAppointment",
          value: function deleteByAppointment() {
            var _this5 = this;

            this.ScheduleAppointmentService.deletemultipleAppointment({
              "appointmentsId": this.upiCheckedId
            }, this.currentUser.id).then(function (res) {
              if (res) {
                // this.goodsData = res.data.pageData;
                _this5.toastService.openSnackBar("Appointment Deleted Successfully!!!");
          ...
          value: function deleteAppointMent(appointmentId) {
            ...
            this.appointId = appointmentId; // console.log("appointment",this.appointId)
          }
        }, {
          key: "removeAppointMent",
          value: function removeAppointMent() {
            var _this6 = this;

            console.log("removeAppointMent");
            this.ScheduleAppointmentService.deleteAppointmentById({}, this.appointId).then(function (res) {
              console.log("----------", res);

              _this6.toastService.openSnackBar("Appointment Deleted Successfully!!!");

              _this6.getAllAppointment();
            }, function (err) {
              if (err.error.expose) {
          ...
          key: "updateModal",
          value: function updateModal(appointmentId) {
            var dialogRef = this.dialog.open(_updateappointment_updateappointment_component__WEBPACK_IMPORTED_MODULE_1__.UpdateappointmentComponent, {
              width: '600px',
              height: '730px',
              data: {
      ...
      _AppointmentPageComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        ...
        template: function AppointmentPageComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("ngModelChange", function AppointmentPageComponent_Template_input_ngModelChange_3_listener($event) {
              return ctx.searchTerm = $event;
            })("ngModelChange", function AppointmentPageComponent_Template_input_ngModelChange_3_listener() {
              return ctx.searchAppoint();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AppointmentPageComponent_Template_button_click_5_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("change", function AppointmentPageComponent_Template_input_change_13_listener($event) {
              return ctx.onChekMultiple($event);
            })("ngModelChange", function AppointmentPageComponent_Template_input_ngModelChange_13_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AppointmentPageComponent_Template_a_click_48_listener() {
              return ctx.removeAppointMent();
            });
        ...
        directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_10__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.NgModel, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.CheckboxControlValueAccessor, _angular_common__WEBPACK_IMPORTED_MODULE_9__.NgIf, _angular_common__WEBPACK_IMPORTED_MODULE_9__.NgForOf, _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouterLinkActive, _angular_material_paginator__WEBPACK_IMPORTED_MODULE_11__.MatPaginator],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_core_services_appointment_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! src/app/core/services/appointment.service */
      19944);
      /* harmony import */
      ...
      function UpdateappointmentComponent_mat_error_19_mat_error_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UpdateappointmentComponent_mat_error_19_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UpdateappointmentComponent_mat_error_28_mat_error_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error");
      ...
      function UpdateappointmentComponent_mat_error_28_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error", 24);
      ...
      function UpdateappointmentComponent_mat_option_37_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UpdateappointmentComponent_mat_error_38_mat_error_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error");
      ...
      function UpdateappointmentComponent_mat_error_38_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error", 24);
      ...
      function UpdateappointmentComponent_mat_option_47_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-option", 26);
      ...
      function UpdateappointmentComponent_mat_error_48_mat_error_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error");
      ...
      function UpdateappointmentComponent_mat_error_48_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error", 24);
      ...
      function UpdateappointmentComponent_mat_error_58_mat_error_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error");
      ...
      function UpdateappointmentComponent_mat_error_58_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error", 24);
      ...
      function UpdateappointmentComponent_mat_error_71_mat_error_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error");
      ...
      function UpdateappointmentComponent_mat_error_71_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error", 24);
      ...
      var _UpdateappointmentComponent = /*#__PURE__*/function () {
        function _UpdateappointmentComponent(formBuilder, scheduleAppointmentService, commonService, appointmentService, toastService, titleCasePipe, router, route, data, dialogRef) {
        ...
        _createClass(_UpdateappointmentComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (params) {
              return _this7.shopID = params['id'];
            });
            this.getappointment();
          }
        }, {
          ...
          key: "saveAppointForm",
          value: function saveAppointForm() {
            var _this8 = this;
            ...
            this.scheduleAppointmentService.postAppointDetails(body).then(function (res) {
              if (res) {
                _this8.toastService.openSnackBar("Shop Appointment Added Successfully."); // this.router.navigate(["/pages/shop-setting/shopID/shop-appointment/shopID"]);
          ...
          key: "getmultipleShop",
          value: function getmultipleShop() {
            var _this9 = this;

            this.scheduleAppointmentService.getmultipleShop({}, this.currentUser.id).then(function (res) {
              console.log("response", res);
              _this9.locations = res.data.map(function (data) {
                console.log("data", data);
                return {
                  // shopId: data[0].client.shopId,
                  tradeName: data.client.tradeName,
                  shopId: data.id // tradeName: data[0].client.tradeName

                };
              });

              if (_this9.locations.length === 0) {
                _this9.toastService.openErrorSnackBar("No shops available. Please create a new shop before adding a new appointment.");
              }

              console.log("locations", _this9.locations);
            });
          }
        }, {
          key: "resetForm",
          ...
          key: "getappointment",
          value: function getappointment() {
            var _this10 = this;

            // console.log("update");
            console.log(this.appointmentId);
            this.appointmentService.getAppointmentById({}, this.appointmentId).then(function (res) {
              _this10.appointListRes = res.data.pageData;

              _this10.addAppointmentform.patchValue({
                name: res.data.name,
          ...
          value: function getAppointmentType() {
            ...
            this.submitted = true; // if (this.appointMentForm.valid) {
            //   return false;
            // }
            ...
            this.appointmentService.UpdateAppointmentDetails(body, this.appointmentId).then(function (res) {
              if (res) {
                _this11.toastService.openSnackBar("Record Updated Successfully!!!");

                _this11.getappointment();
              ...
              if (err.error.expose) {
                _this11.toastService.openErrorSnackBar(_this11.titleCasePipe.transform(err.error.error_message));
              } else {
                _this11.toastService.openErrorSnackBar("Something Went Wrong.");
              }
            });
          }
        }, {
      ...
      _UpdateappointmentComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
        ...
        template: function UpdateappointmentComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function UpdateappointmentComponent_Template_button_click_4_listener() {
              return ctx.cancel();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function UpdateappointmentComponent_Template_button_click_6_listener() {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _time_schedule_page_edit_time_schedule_page_edit_time_schedule_page_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./time-schedule-page/edit-time-schedule-page/edit-time-schedule-page.component */
      20289);
      /* harmony import */
      ...
      /*! @angular/core */
      2316); // import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_core_services_schedule_schedule_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      function ShopDetailsPageComponent_tr_19_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function ShopDetailsPageComponent_tr_19_Template_button_click_12_listener() {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r5);

            var shop_r2 = restoredCtx.$implicit;

            var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]();

            return ctx_r4.isActiveShop(shop_r2.id, shop_r2.isActive);
          });
      ...
      function ShopDetailsPageComponent_tbody_20_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _ShopDetailsPageComponent = /*#__PURE__*/function () {
        function _ShopDetailsPageComponent(formBuilder, ScheduleShopService, toastService, titleCasePipe, scheduleScheduleService) {
        ...
        _createClass(_ShopDetailsPageComponent, [{
          ...
          value: function getShopList() {
            ...
            this.ScheduleShopService.getShopList({}, this.currentUser.id).then(function (res) {
              if (res.data.rows) {
                _this12.ShopListResponse = res.data.rows;
              }
            }, function (err) {
              if (err.error.expose) {
          ...
          key: "isActiveShop",
          value: function isActiveShop(shopId, isActiveById) {
            var _this13 = this;

            var isActive = !isActiveById;
            var body = {
              "isActive": isActive
            };
            this.ScheduleShopService.isActiveShop(body, shopId).then(function (res) {
              if (res.success) {
                if (isActive) {
                  _this13.toastService.openSnackBar("Shop status changed to active");

                  _this13.getShopList();
                } else {
                  _this13.toastService.openSnackBar("Shop status changed to inactive");
          ...
          value: function searchShop() {
            ...
            if (this.searchTerm.trim() === '') {
              ...
              this.ScheduleShopService.getShopList({}, this.currentUser.id).then(function (res) {
                _this14.ShopListResponse = res.data.rows.filter(function (item) {
                  return (// item.scheduleName.toLowerCase().includes(this.searchTerm.toLowerCase()) ||
                    item.email && item.email.toLowerCase().includes(_this14.searchTerm.toLowerCase()) || item.client.tradeName && item.client.tradeName.toLowerCase().includes(_this14.searchTerm.toLowerCase()) // item.appointmentType.locationType.toLowerCase().includes(this.searchTerm.toLowerCase())
      ...
      _ShopDetailsPageComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        type: _ShopDetailsPageComponent,
        selectors: [["app-shop-details-page"]],
        decls: 37,
        vars: 3,
        consts: [[1, "container-fluid", "bg-white", "p-0"], ["id", "showoptionHide", 1, "row", "headerButtons", "mb-3"], [1, "flex-item", "searchBar", "me-4"], ["type", "search", "id", "searchInput", "placeholder", "Name/Email", "autocomplete", "off", 1, "form-control", "pe-5", 3, "ngModel", "ngModelChange"], [2, "width", "100%", "overflow-x", "auto"], [1, "table", "table-responsive", "table-bordered", "fs--1", "mb-0"], [1, "text-600"], [1, "text-nowrap", 2, "vertical-align", "middle"], ["class", "btn-reveal-trigger text-left", "style", "color: #676398!important;", 4, "ngFor", "ngForOf"], [4, "ngIf"], ["id", "errorDelete-modal", "tabindex", "-1", "role", "dialog", "aria-hidden", "true", 1, "modal", "fade"], ["role", "document", 1, "modal-dialog", "modal-dialog-centered", 2, "max-width", "350px"], [1, "modal-content", "position-relative"], [1, "position-absolute", "top-0", "end-0", "mt-2", "me-2", "z-index-1"], ["data-bs-dismiss", "modal", "aria-label", "Close", 1, "btn-close", "btn", "btn-sm", "btn-circle", "d-flex", "flex-center", "transition-base"], [1, "modal-body", "p-0"], [1, "rounded-top-lg", "py-3", "ps-4", "pe-6", "bg-light"], ["id", "modalExampleDemoLabel", 1, "mb-1", "text-center", "font-weight-bold", 2, "font-weight", "800"], [1, "text-center"], [1, "modal-footer", "justify-content-center"], ["data-bs-dismiss", "modal", 1, "btn", "btn-outline-success"], ["data-bs-dismiss", "modal", 1, "btn", "btn-outline-danger"], [1, "btn-reveal-trigger", "text-left", 2, "color", "#676398!important"], [2, "vertical-align", "middle"], [1, "barcode", 2, "vertical-align", "middle"], [1, "category", 2, "vertical-align", "middle"], [1, "openingStock", 2, "vertical-align", "middle"], [2, "vertical-align", "middle", "white-space", "nowrap"], [1, "ps-5"], [1, "toggle-button", 3, "ngClass", "click"], [1, "toggle-slider"], ["colspan", "10"], ["src", "../../../assets/img/icons/spot-illustrations/notfound1.png", "alt", "notfound1", "width", "200", "height", "150", 1, "image-responsive"]],
        template: function ShopDetailsPageComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("ngModelChange", function ShopDetailsPageComponent_Template_input_ngModelChange_3_listener($event) {
              return ctx.searchTerm = $event;
            })("ngModelChange", function ShopDetailsPageComponent_Template_input_ngModelChange_3_listener() {
              return ctx.searchShop();
            });
        ...
        _createClass(_UpdateShopComponent, [{
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      return this.scheduleShopService.getshopListBYshopId({}, this.shopId).then(function (res) {
                        console.log(res);
                        _this17.data = res.data;
                        _this17.constitutionBusinessType = res.data.client.businessType;
                        var primaryAddress = res.data.primaryAddress;

                        if (res.data.client.gstType == "Composite") {
                          _this17.compositeType = true;
                        }

                        if (primaryAddress.length > 0) {
                          for (var i = 0; i < primaryAddress.length; i++) {
                            _this17.addressId = primaryAddress[i].id;

                            _this17.addressControls.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormGroup({
                        ...
                        if (res.data.client.isRegistered != null) {
                          _this17.toggleShow(res.data.additional.isRegistered); // this.isShown = res.data.additional.isRegistered;
                        ...
                        // this.categoryCtrl.setValue(businesscategory);
                        //sending data from get api to form by patching
                        _this17.ProfileForm.patchValue({
          ...
          value: function getPincodeDetails(pin) {
            ...
            this.profileService.getUserPincode({}, pin).then(function (res) {
              _this18.pinDetails = res;

              _this18.ProfileForm.patchValue({
          ...
          value: function getPincodeDetailsForAdditionalAddress(pin, index) {
            ...
            if (pin.length == 6) {
              this.profileService.getUserPincode({}, pin).then(function (res) {
                _this19.pinDetails = res.data;

                _this19.addressControls.controls[index].patchValue({
                  pincode: _this19.pinDetails.pincode,
                  state: _this19.pinDetails.stateName,
                  district: _this19.pinDetails.districtName
                });

                _this19.addressControls.at(index).patchValue(res.data.stateName, res.data.districtName);
              });
            }
          }
        }, {
          ...
          value: function getGstNumber(gstin) {
            ...
            this.profileService.getGstNumber({}, gstin).then(function (res) {
              _this20.gstDetails = res;

              if (res) {
                _this20.ProfileForm.patchValue({
                ...
                _this20.isDisabledGST = false;
              }
            }, function (err) {
              _this20.isDisabledGST = true;
            });
          }
          /**
          ...
          value: function getType() {
            ...
            this.profileService.getTypes({}).then(function (response) {
              _this21.typeList = response.data;
            });
          }
          /**
           * Update user profile
          ...
          value: function UpdateNewShop() {
            ...
            if (this.ProfileForm.valid) {
              this.scheduleShopService.UpdateShopDetails(finalObject, this.shopId).then(function (res) {
                if (res.success) {
                  _this22.router.navigate(["/pages/shop-schedule-page/shop-details-list"]);
                }
              }, function (err) {
                if (err.error.ststus == 500) {
                  _this22.toastService.openErrorSnackBar(err.error.error_message);
                } else {
                  _this22.toastService.openErrorSnackBar(err.error.error_message);
                }
              });
          ...
          value: function addMultipleAddress() {
            ...
            if (newAddress && newAddress.address && newAddress.city && newAddress.country && newAddress.district && newAddress.homeno && newAddress.landmark && newAddress.pincode && newAddress.state) {
              ...
              this.profileService.postMultipleAddress({
                ...
                if (res.success) {
                  _this23.toastService.openSnackBar("Address Added Successfully!!!");

                  window.location.reload();
                  _this23.addressArray = [];
                }
              }, function (err) {
                if (err.error.status == 400) {
                  _this23.toastService.openErrorSnackBar("Fill All Additional Address Details.");
                }
              });
            }
          }
          ...
          value: function updateMultipleAddress(item) {
            ...
            this.profileService.updateMultipleAddress(data, item.value.id).then(function (res) {
              if (res) {
                _this24.toastService.openSnackBar("Address Updated Successfully!!!");
          ...
          value: function deleteAddress(item) {
            ...
            this.profileService.deleteAddressById({}, item.value.id).then(function (res) {
              if (res) {
                _this25.toastService.openSnackBar("Address Deleted Successfully!!!");
          ...
          value: function addPlaceOfBusiness() {
            ...
            if (this.businessPlaceAdd.valid) {
              ...
              this.profileService.postMultipleAddress({
                ...
                if (res.success) {
                  _this26.toastService.openSnackBar("Address Added Successfully!!!"); // window.location.reload();


                  _this26.businessPlaceAdd.reset();
                }
              }, function (err) {
                if (err.error.status == 400) {
                  _this26.toastService.openErrorSnackBar("Fill All Additional Address Details.");
                } else {
          ...
          value: function updateMobile() {
            ...
            this.profileService.updateClientMobileOTP(data, this.currentUser.id).then(function (res) {
              _this27.toastService.openSnackBar("OTP Sent Successfully!!!");
            });
          }
          /**
           *
          ...
          value: function updateMobileNumber() {
            ...
            this.profileService.updateClientMobile(data).then(function (res) {
              _this28.toastService.openSnackBar("Mobile Number Verified Successfully!!!");
            });
          }
          /**
          ...
          value: function selected(event) {
            ...
            requestAnimationFrame(function () {
              _this29.openAuto(_this29.matACTrigger);
            });
          }
          /**
          ...
          value: function searchCategoryByCategory(categoryInput) {
            ...
            this.profileService.getCategoryBySearch({}, categoryInput).then(function (res) {
              _this30.serachByCategory = res.data;
            });
          }
          /**
           * Get all categories
          ...
          value: function getBusinessCategory() {
            ...
            this.profileService.getBuisnessCategoryAll({}).then(function (res) {
              _this31.categoryBusiness = res.data.rows;
              _this31.filteredCategory = _this31.categoryCtrl.valueChanges.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.startWith)(""), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.map)(function (name) {
                return name ? _this31.filterNames(name) : _this31.categoryBusiness.slice();
              }));
            });
          }
          /**
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "EditTimeSchedulePageComponent": function EditTimeSchedulePageComponent() {
          return (
            /* binding */
            _EditTimeSchedulePageComponent
          );
        }
        /* harmony export */
      ...
      var _EditTimeSchedulePageComponent = /*#__PURE__*/function () {
        function _EditTimeSchedulePageComponent(dialogRef, data, formBuilder, router, route, toastService, titleCasePipe) {
          _classCallCheck(this, _EditTimeSchedulePageComponent);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _add_time_schedule_add_time_schedule_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./add-time-schedule/add-time-schedule.component */
      80476);
      /* harmony import */


      var _edit_time_schedule_page_edit_time_schedule_page_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./edit-time-schedule-page/edit-time-schedule-page.component */
      20289);
      /* harmony import */
      ...
      function TimeSchedulePageComponent_span_14_button_1_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function TimeSchedulePageComponent_span_14_button_1_span_1_Template_span_click_0_listener($event) {
      ...
      function TimeSchedulePageComponent_span_14_button_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function TimeSchedulePageComponent_span_14_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function TimeSchedulePageComponent_tr_25_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("change", function TimeSchedulePageComponent_tr_25_Template_input_change_2_listener($event) {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r15);

            var schedule_r12 = restoredCtx.$implicit;

            var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();

            return ctx_r14.onChekedsingleCheck($event, schedule_r12.id);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function TimeSchedulePageComponent_tr_25_Template_span_click_14_listener() {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r15);
            ...
            return ctx_r16.getTimeScheduleId(schedule_r12.id);
          });
      ...
      function TimeSchedulePageComponent_tbody_26_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function TimeSchedulePageComponent_mat_paginator_27_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("page", function TimeSchedulePageComponent_mat_paginator_27_Template_mat_paginator_page_0_listener($event) {
            ...
            return ctx_r17.handlePage($event);
          });
      ...
      function TimeSchedulePageComponent_h4_53_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function TimeSchedulePageComponent_h4_54_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "h4", 24);
      ...
      function TimeSchedulePageComponent_a_58_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function TimeSchedulePageComponent_a_58_Template_a_click_0_listener() {
            ...
            return ctx_r19.deleteBySchedule();
          });
      ...
      function TimeSchedulePageComponent_a_59_Template(rf, ctx) {
        if (rf & 1) {
          var _r22 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "a", 27);

          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function TimeSchedulePageComponent_a_59_Template_a_click_0_listener() {
            ...
            return ctx_r21.deleteBySchedule();
          });
      ...
      var _TimeSchedulePageComponent = /*#__PURE__*/function () {
        function _TimeSchedulePageComponent(formBuilder, modal, route, scheduleScheduleService, dialog, scheduleShopService, commonService, toastService, titleCasePipe) {
        ...
        _createClass(_TimeSchedulePageComponent, [{
          ...
          value: function getAllSchedule() {
            ...
            this.scheduleScheduleService.getAllSchedule({}, this.currentUser.id, this.schedulePageSize, this.currentPageNo).then(function (res) {
              _this33.schduleAllRes = res.data.pageData;
              console.log("schduleAllRes", res.data);
              _this33.currentPageNo = res.data.currentPage;
              _this33.totalrow = res.data.totalrows;
              _this33.toatlPages = res.data.totalPages;
            });
          }
        }, {
          key: "searchFunc",
          value: function searchFunc() {
            ...
            if (this.searchTerm.trim() === '') {
              ...
              this.scheduleScheduleService.getAllSchedule({}, this.currentUser.id, this.schedulePageSize, this.currentPageNo).then(function (res) {
                _this34.schduleAllRes = res.data.pageData.filter(function (item) {
                  return item.scheduleName.toLowerCase().includes(_this34.searchTerm.toLowerCase()) || item.appointmentType.name.toLowerCase().includes(_this34.searchTerm.toLowerCase()) || item.appointmentType.locationType.toLowerCase().includes(_this34.searchTerm.toLowerCase());
                });
              });
          ...
          value: function getShopList() {
            ...
            this.scheduleShopService.getShopList({}, this.currentUser.id).then(function (res) {
              _this35.shopListWithId = res.data.rows.map(function (data) {
                return {
                  tradeName: data.client.tradeName,
                  shopId: data.id
                };
          ...
          value: function onChekMultiple($event) {
            ...
            this.isChecked = $event.target.checked;
            console.log("this.isChecked", this.isChecked);
            this.upiCheckedId1 = this.schduleAllRes.map(function (item) {
              if (id == -1) {
                if (_this36.isChecked == true) {
                  _this36.archiveIconfalse = true;
                  _this36.checkSelectsinglefalse = true;
                  return item;
                } else {
                  _this36.archiveIconfalse = false;
                  _this36.checkSelectsinglefalse = false;
                  _this36.upiCheckedId = [];
                  _this36.upiCheckedId1 = [];
                }
              }
            });
            console.log("multiple click", this.upiCheckedId1);
          ...
          key: "getSingleCheckedId",
          value: function getSingleCheckedId(e, scheduleId) {
            this.currentScheduleId = this.scheduleId;
          }
        }, {
          key: "getUPIcheckId",
          value: function getUPIcheckId(e, scheduleId) {
            this.currentScheduleId = this.scheduleId;
          ...
          key: "onChekedsingleCheck",
          value: function onChekedsingleCheck(e, scheduleId) {
            if (e.target.checked) {
              this.upiCheckedId.push(scheduleId);
            } else {
              var index = this.upiCheckedId.indexOf(scheduleId);
          ...
          key: "deleteBySchedule",
          value: function deleteBySchedule() {
            var _this37 = this;

            this.scheduleShopService.deletemultipleSchedule({
              "schedulesId": this.upiCheckedId
            }, this.currentUser.id).then(function (res) {
              if (res.success) {
                // this.goodsData = res.data.pageData;
                _this37.toastService.openSnackBar("Schedule Deleted Successfully!!!");

                _this37.archiveIconfalse = false;
                _this37.allSelect = false;
                _this37.checkSelectsinglefalse = false;
                _this37.isChecked = false;
                _this37.upiCheckedId = [];
                _this37.checkSingleArray = [];

                _this37.getAllSchedule();
              }
            }, function (err) {
              if (err.error.expose) {
                _this37.toastService.openErrorSnackBar(_this37.titleCasePipe.transform(err.error.error_message));
              } else {
                _this37.toastService.openErrorSnackBar("Something Went Wrong.");
              }
            });
          }
        }, {
          ...
          value: function deleteSchedule() {
            ...
            this.scheduleShopService.deleteschedulybyId({}, this.currentScheduleId).then(function (res) {
              if (res.success) {
                _this38.toastService.openSnackBar("Schedule Deleted Successfully!!!");

                _this38.getAllSchedule();
              }
            });
          }
        }, {
          key: "getTimeScheduleId",
          value: function getTimeScheduleId(scheduleId) {
            this.currentScheduleId = scheduleId;
          }
        }, {
          key: "addTimeScheduleModal",
          value: function addTimeScheduleModal() {
            console.log("in here");
            var dialogRef = this.dialog.open(_add_time_schedule_add_time_schedule_component__WEBPACK_IMPORTED_MODULE_0__.AddTimeScheduleComponent, {
              width: '700px',
              height: '730px',
          ...
          key: "openViewModal",
          value: function openViewModal(scheduleId) {
            var dialogRef = this.dialog.open(_edit_time_schedule_page_edit_time_schedule_page_component__WEBPACK_IMPORTED_MODULE_1__.EditTimeSchedulePageComponent, {
              width: '700px',
              height: '730px',
      ...
      _TimeSchedulePageComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
        ...
        template: function TimeSchedulePageComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function TimeSchedulePageComponent_Template_input_ngModelChange_3_listener($event) {
              return ctx.searchTerm = $event;
            })("ngModelChange", function TimeSchedulePageComponent_Template_input_ngModelChange_3_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function TimeSchedulePageComponent_Template_button_click_5_listener() {
              return ctx.addTimeScheduleModal();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("change", function TimeSchedulePageComponent_Template_input_change_13_listener($event) {
              return ctx.onChekMultiple($event);
            })("ngModelChange", function TimeSchedulePageComponent_Template_input_ngModelChange_13_listener($event) {
              return ctx.allSelect = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function TimeSchedulePageComponent_Template_a_click_42_listener() {
