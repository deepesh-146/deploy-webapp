    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function NewticketpageComponent_span_28_button_1_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function NewticketpageComponent_span_28_button_1_span_1_Template_span_click_0_listener($event) {
        ...
        _createClass(_NewticketpageComponent, [{
          ...
          value: function getEnquirysearch(search) {
            ...
            if (this.searchKey == "") {
              ...
              this.toastService.toastMsg({
                title: "Error",
                content: "Please Enter Valid Enquiry Name!!!"
              });
