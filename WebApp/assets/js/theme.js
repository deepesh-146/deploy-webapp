...
var totalSalesEcommerce = function totalSalesEcommerce() {
  ...
  function getFormatter(params) {
    return params.map(function (_ref4, index) {
...
var cookieNoticeInit = function cookieNoticeInit() {
  ...
  btnNoticeToggle && btnNoticeToggle.addEventListener(Events.CLICK, function (_ref5) {
...
var draggableInit = function draggableInit() {
  ...
  if (columnContainers.length) {
    ...
    sortable.on(Events.DRAG_STOP, function (_ref6) {
      var el = _ref6.data.source;
...
var renderCalendar = function renderCalendar(el, option) {
  ...
  calendar.render();
  (_document$querySelect5 = document.querySelector('.navbar-vertical-toggle')) === null || _document$querySelect5 === void 0 ? void 0 : _document$querySelect5.addEventListener('navbar.vertical.toggle', function () {
...
function initMap() {
  ...
  if ($googlemaps.length && window.google) {
    ...
    $googlemaps.forEach(function (itm) {
      ...
      themeController && themeController.addEventListener('clickControl', function (_ref7) {
        var _ref7$detail = _ref7.detail,
            control = _ref7$detail.control,
            value = _ref7$detail.value;
...
var kanbanInit = function kanbanInit() {
  ...
  if (addListForm) {
    ...
    addListForm.addEventListener(Events.SHOW_BS_COLLAPSE, function (_ref10) {
    ...
    addListForm.addEventListener(Events.SHOWN_BS_COLLAPSE, function (_ref11) {
  ...
  collapseDismissButtons.forEach(function (button) {
    button.addEventListener(Events.CLICK, function (_ref12) {
...
var searchInit = function searchInit() {
  ...
  searchAreas.forEach(function (searchArea) {
    ...
    document.addEventListener(Events.CLICK, function (_ref15) {
...
var tinymceInit = function tinymceInit() {
  if (window.tinymce) {
    ...
    var themeController = document.body;
    themeController && themeController.addEventListener('clickControl', function (_ref16) {
