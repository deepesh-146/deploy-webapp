(function () {
  ...
  (self["webpackChunkweb_app"] = self["webpackChunkweb_app"] || []).push([["src_app_pages_timesheet_timesheet_module_ts"], {
        ...
        _createClass(_ApprovalsComponent, [{
          ...
          value: function ontrueclick(leavid) {
            ...
            this.timesheetService.approvalstatusById(body, this.currentUser.id, this.leavid).then(function (res) {
              if (res) {
                ...
                _this3.toastService.openSnackBar("Leave Approval Successfully!!!");
          ...
          value: function onfalseclick(leavid) {
            ...
            this.timesheetService.approvalstatusById(body1, this.currentUser.id, this.leavid1).then(function (res) {
              if (res) {
                ...
                _this4.toastService.openSnackBar("Leave Denied Successfully!!!");
          ...
          value: function deleteapprovalById() {
            ...
            this.timesheetService.deleteapprovalDeleteById({}, this.approvalId).then(function (res) {
              if (res) {
                _this5.toastService.openSnackBar("Leave Approval Deleted Successfully!!!");
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function DailyComponent_span_14_button_1_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function DailyComponent_span_14_button_1_span_1_Template_span_click_0_listener($event) {
      ...
      function DailyComponent_span_14_button_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DailyComponent_span_14_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "span");
      ...
      function DailyComponent_tr_25_Template(rf, ctx) {
        if (rf & 1) {
          var _r14 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("change", function DailyComponent_tr_25_Template_input_change_2_listener($event) {
      ...
      function DailyComponent_tbody_26_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "tbody");
      ...
      function DailyComponent_h4_52_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DailyComponent_a_57_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function DailyComponent_a_57_Template_a_click_0_listener() {
        ...
        _createClass(_DailyComponent, [{
          ...
          value: function onDeleteDailyTime() {
            ...
            this.timesheetService.deleteTimeDeleteById({}, this.timeId).then(function (res) {
              ...
              _this10.toastService.openSnackBar("TimeSheet Deleted Successfully!!!");
          ...
          value: function deleteProductById() {
            ...
            this.timesheetService.multideleteTimeDeleteById(request, this.currentUser.id).then(function (res) {
              ...
              _this11.toastService.openSnackBar("TimeSheet Deleted Successfully!!!");
      ...
      _DailyComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
        ...
        template: function DailyComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("change", function DailyComponent_Template_input_change_13_listener($event) {
              return ctx.onChekMultiple($event);
            })("ngModelChange", function DailyComponent_Template_input_ngModelChange_13_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function DailyComponent_Template_a_click_41_listener() {
            ...
            if (this.EditTimeForm.invalid) {
              ...
              if (this.EditTimeForm.controls.start_time.value < this.EditTimeForm.controls.end_time.value) {
                ...
                this.timesheetService.editTime(body, this.timeId).then(function (res) {
                  ...
                  _this14.toastService.openSnackBar("Time Updated Successfully!!!");
          ...
          value: function calculateTimeDifference() {
            ...
            if (startTimeValue && endTimeValue) {
              ...
              if (startDate < endDate) {
                ...
                this.toastService.openErrorSnackBar("Start time must be less than end time!!!"); //this.timeDifferenceFormatted = '';
          ...
          value: function onsubmit(content) {
            ...
            this.timesheetService.getleavesetting(Body, this.currentUser.id).then(function (res) {
              if (res) {
                ...
                _this16.toastService.openSnackBar("All Leave Added Successfully!!!");
          ...
          value: function onupdate(content) {
            ...
            this.timesheetService.getleavesettingupdate(body, this.currentUser.id).then(function (res) {
              if (res) {
                ...
                _this17.toastService.openSnackBar("All Leave Update Successfully!!!");
