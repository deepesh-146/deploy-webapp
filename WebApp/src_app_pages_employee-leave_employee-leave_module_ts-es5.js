  ...
  (self["webpackChunkweb_app"] = self["webpackChunkweb_app"] || []).push([["src_app_pages_employee-leave_employee-leave_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "EmpleaveserviceService": function EmpleaveserviceService() {
          return (
            /* binding */
            _EmpleaveserviceService
          );
        }
        /* harmony export */
      ...
      var _EmpleaveserviceService = /*#__PURE__*/function () {
        function _EmpleaveserviceService(httpClient) {
          _classCallCheck(this, _EmpleaveserviceService);
        ...
        _createClass(_EmpleaveserviceService, [{
          key: "notifyLeaveAdded",
          value: function notifyLeaveAdded() {
            this.leaveAddedSource.next();
          }
        }, {
          key: "getAllLeaveDetails",
          value: function getAllLeaveDetails(data, empId) {
            var _this = this;

            return new Promise(function (resolve, reject) {
              _this.httpClient.call(data, src_app_helpers_url_constants__WEBPACK_IMPORTED_MODULE_0__.UrlConstants.empgetAllleave + empId, 'GET').subscribe(function (res) {
                return resolve(res);
              }, function (err) {
                return reject(err);
              });
          ...
          key: "getAllLeaveDetails1",
          value: function getAllLeaveDetails1(data, empId) {
            var _this2 = this;

            return new Promise(function (resolve, reject) {
              _this2.httpClient.call(data, src_app_helpers_url_constants__WEBPACK_IMPORTED_MODULE_0__.UrlConstants.empgetAllleave1 + empId, 'GET').subscribe(function (res) {
                return resolve(res);
              }, function (err) {
                return reject(err);
              });
          ...
          key: "addLeaveDetails",
          value: function addLeaveDetails(data) {
            var _this3 = this;

            return new Promise(function (resolve, reject) {
              _this3.httpClient.call(data, src_app_helpers_url_constants__WEBPACK_IMPORTED_MODULE_0__.UrlConstants.empaddleave, 'POST').subscribe(function (res) {
                return resolve(res);
              }, function (err) {
                return reject(err);
              });
          ...
          key: "GetLeaveByEducationId",
          value: function GetLeaveByEducationId(data, leaveId) {
            var _this4 = this;

            return new Promise(function (resolve, reject) {
              _this4.httpClient.call(data, src_app_helpers_url_constants__WEBPACK_IMPORTED_MODULE_0__.UrlConstants.empgetByIdleave + leaveId, 'GET').subscribe(function (res) {
                return resolve(res);
              }, function (err) {
                return reject(err);
              });
          ...
          key: "LeaveUpdateByEmployeeId",
          value: function LeaveUpdateByEmployeeId(data, empId) {
            var _this5 = this;

            return new Promise(function (resolve, reject) {
              _this5.httpClient.call(data, src_app_helpers_url_constants__WEBPACK_IMPORTED_MODULE_0__.UrlConstants.empupdateByIdleave + empId, 'PUT').subscribe(function (res) {
                return resolve(res);
              }, function (err) {
                return reject(err);
              });
          ...
          key: "deleteLeave",
          value: function deleteLeave(data, leaveId) {
            var _this6 = this;

            return new Promise(function (resolve, reject) {
              _this6.httpClient.call(data, src_app_helpers_url_constants__WEBPACK_IMPORTED_MODULE_0__.UrlConstants.empdeleteByIdleave + leaveId, 'DELETE').subscribe(function (res) {
                return resolve(res);
              }, function (err) {
                return reject(err);
              });
        ...
        return _EmpleaveserviceService;
      }();

      _EmpleaveserviceService.ɵfac = function EmpleaveserviceService_Factory(t) {
        return new (t || _EmpleaveserviceService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_http_service__WEBPACK_IMPORTED_MODULE_1__.HttpService));
      };

      _EmpleaveserviceService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjectable"]({
        token: _EmpleaveserviceService,
        factory: _EmpleaveserviceService.ɵfac,
        providedIn: 'root'
      });
      /***/
    },
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddLeaveemployeeComponent": function AddLeaveemployeeComponent() {
          return (
            /* binding */
            _AddLeaveemployeeComponent
          );
        }
        /* harmony export */
      ...
      var src_app_core_services_empleaveservice_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! src/app/core/services/empleaveservice.service */
      61803);
      /* harmony import */
      ...
      function AddLeaveemployeeComponent_mat_error_19_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AddLeaveemployeeComponent_mat_option_27_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AddLeaveemployeeComponent_mat_option_28_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AddLeaveemployeeComponent_mat_option_29_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AddLeaveemployeeComponent_mat_option_30_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AddLeaveemployeeComponent_mat_error_31_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "mat-error", 27);
      ...
      function AddLeaveemployeeComponent_mat_error_43_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "mat-error", 27);
      ...
      function AddLeaveemployeeComponent_mat_error_54_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "mat-error", 27);
      ...
      function AddLeaveemployeeComponent_mat_option_63_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AddLeaveemployeeComponent_mat_error_64_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "mat-error", 27);
      ...
      var _AddLeaveemployeeComponent = /*#__PURE__*/function () {
        function _AddLeaveemployeeComponent(dialogRef, cdr, formBuilder, router, toastService, titleCasePipe, UserData, productService, leaveservice) {
          _classCallCheck(this, _AddLeaveemployeeComponent);
        ...
        _createClass(_AddLeaveemployeeComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this7 = this;

            this.userId = this.UserData.userId;
            this.getleaveDetailsdays(); // setTimeout(() => {
            //   this.options = ['Full Day', 'Half Day'];
            // }, 2000);
            ...
            this.addleaveForm = this.formBuilder.group({
              ...
              day: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required]] //  uploadDocument: [""],

            }); // Subscribe to value changes of leaveStartDate and leaveEndDate controls

            this.addleaveForm.get('leaveStartDate').valueChanges.subscribe(function () {
              _this7.calculateNumberOfDays();
            });
            this.addleaveForm.get('leaveEndDate').valueChanges.subscribe(function () {
              _this7.calculateNumberOfDays();
            });
          }
        }, {
          key: "getleaveDetailsdays",
          value: function getleaveDetailsdays() {
            var _this8 = this;

            this.leaveservice.getAllLeaveDetails1({}, this.currentEmployee.id).then(function (res) {
              console.log("res days Assign", res);
              _this8.sickleavedata = res.data.totalLeaveTaken["Sick Leave"];
              console.log(_this8.sickleavedata);
              _this8.casualleavedata = res.data.totalLeaveTaken["Casual Leave"];
              console.log(_this8.casualleavedata);
              _this8.privilageleavedata = res.data.totalLeaveTaken["Privilage Leave"];
              console.log(_this8.privilageleavedata);
              _this8.compensatoryleavedata = res.data.totalLeaveTaken["Compensatory Leave"];
          ...
          key: "calculateNumberOfDays",
          value: function calculateNumberOfDays() {
            var startDate = this.addleaveForm.get('leaveStartDate').value;
            var endDate = this.addleaveForm.get('leaveEndDate').value;
            ...
            if (startDate && endDate) {
              ...
              var numberOfDays = Math.ceil(timeDifference / (1000 * 3600 * 24)); // Update the numberOfDays property
          ...
          value: function openDatepickerstart() {
            ...
            var selectedDate = this.addleaveForm.get('leaveStartDate').value;
          ...
          value: function openDatepickerend() {
            // Check if the current value of taskdate is an "Invalid Date"
            var selectedDate = this.addleaveForm.get('leaveEndDate').value;
            ...
            if (e.target.files && e.target.files[0]) {
              ...
              if (file == null) {
                ...
                this.productService.PostImagePdf(formdata).then(function (res) {
                  _this10.productPicUrl = res.data.location;
                  console.log("this.productPicUrl", _this10.productPicUrl);
                });
              }
            }
          }
      ...
      _AddLeaveemployeeComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        ...
        template: function AddLeaveemployeeComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AddLeaveemployeeComponent_Template_button_click_4_listener() {
              return ctx.cancel();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AddLeaveemployeeComponent_Template_button_click_6_listener() {
              return ctx.postLeave();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AddLeaveemployeeComponent_Template_input_click_39_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AddLeaveemployeeComponent_Template_input_click_50_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("change", function AddLeaveemployeeComponent_Template_input_change_70_listener($event) {
        ...
        styles: [".modal-body[_ngcontent-%COMP%] {\n  height: calc(100% - 125px);\n  overflow-y: auto;\n}\n\n.iconcalender[_ngcontent-%COMP%] {\n  float: right !important;\n  margin-top: -25px !important;\n  margin-right: 7px !important;\n}\n\n.modal-header[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n}\n\n.addProductButtons[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  margin-left: auto;\n}\n\n@media screen and (max-width: 768px) {\n  .modal-header[_ngcontent-%COMP%] {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n  }\n\n  .addProductButtons[_ngcontent-%COMP%] {\n    margin: 10px 0px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
      });
      /***/
    },
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "EditLeaveemployeeComponent": function EditLeaveemployeeComponent() {
          return (
            /* binding */
            _EditLeaveemployeeComponent
          );
        }
        /* harmony export */
      ...
      function EditLeaveemployeeComponent_mat_error_19_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditLeaveemployeeComponent_mat_option_27_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditLeaveemployeeComponent_mat_option_28_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditLeaveemployeeComponent_mat_option_29_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditLeaveemployeeComponent_mat_option_30_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditLeaveemployeeComponent_mat_error_31_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error", 27);
      ...
      function EditLeaveemployeeComponent_mat_error_43_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error", 27);
      ...
      function EditLeaveemployeeComponent_mat_error_54_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error", 27);
      ...
      function EditLeaveemployeeComponent_mat_option_63_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditLeaveemployeeComponent_mat_error_64_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "mat-error", 27);
      ...
      var _EditLeaveemployeeComponent = /*#__PURE__*/function () {
        function _EditLeaveemployeeComponent(dialogRef, cdr, formBuilder, router, toastService, titleCasePipe, UserData, leaveservice, productService) {
          _classCallCheck(this, _EditLeaveemployeeComponent);
        ...
        _createClass(_EditLeaveemployeeComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this11 = this;
            ...
            this.getLeaveById(); // Subscribe to value changes of leaveStartDate and leaveEndDate controls

            this.editleaveForm.get('leaveStartDate').valueChanges.subscribe(function () {
              _this11.calculateNumberOfDays();
            });
            this.editleaveForm.get('leaveEndDate').valueChanges.subscribe(function () {
              _this11.calculateNumberOfDays();
            });
          }
        }, {
          key: "calculateNumberOfDays",
          value: function calculateNumberOfDays() {
            var startDate = this.editleaveForm.get('leaveStartDate').value;
            var endDate = this.editleaveForm.get('leaveEndDate').value;
          ...
          value: function createEductionForm() {
            this.editleaveForm = this.formBuilder.group({
              ...
              day: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required]] //uploadDocument: [""],
          ...
          value: function getleaveDetailsdays() {
            ...
            this.leaveservice.getAllLeaveDetails1({}, this.currentEmployee.id).then(function (res) {
              console.log("res days Assign", res);
              _this12.sickleavedata = res.data.totalLeaveTaken["Sick Leave"];
              console.log(_this12.sickleavedata);
              _this12.casualleavedata = res.data.totalLeaveTaken["Casual Leave"];
              console.log(_this12.casualleavedata);
              _this12.privilageleavedata = res.data.totalLeaveTaken["Privilage Leave"];
              console.log(_this12.privilageleavedata);
              _this12.compensatoryleavedata = res.data.totalLeaveTaken["Compensatory Leave"];
          ...
          key: "getLeaveById",
          value: function getLeaveById() {
            var _this13 = this;

            this.leaveservice.GetLeaveByEducationId({}, this.leaveId).then(function (res) {
              console.log("get data in perticular lead", res);
              _this13.productPicUrl = res.data.leaveApplication;

              _this13.editleaveForm.patchValue({
          ...
          value: function UpdateLeave() {
            ...
            if (this.editleaveForm.invalid) {
              ...
              var Body = {
                ...
                "noOfLeavesDays": this.numberOfDays,
                "leaveApplication": this.productPicUrl,
                "userId": this.userId //"status": "REJECTED"
          ...
          value: function openDatepickerstart() {
            // Check if the current value of taskdate is an "Invalid Date"
            var selectedDate = this.editleaveForm.get('leaveStartDate').value;
          ...
          value: function openDatepickerend() {
            // Check if the current value of taskdate is an "Invalid Date"
            var selectedDate = this.editleaveForm.get('leaveEndDate').value;
          ...
          value: function documentChange(e) {
            ...
            if (e.target.files && e.target.files[0]) {
              ...
              if (file == null) {
                ...
                formdata.set("upload", file);
                this.productService.PostImagePdf(formdata).then(function (res) {
                  _this15.productPicUrl = res.data.location;
                  console.log("this.productPicUrl", _this15.productPicUrl);
                });
              }
            }
          }
        ...
        return _EditLeaveemployeeComponent;
      }();

      _EditLeaveemployeeComponent.ɵfac = function EditLeaveemployeeComponent_Factory(t) {
        return new (t || _EditLeaveemployeeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__.MatDialogRef), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_4__.ChangeDetectorRef), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormBuilder), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_7__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](src_app_core_services_toast_notification_service__WEBPACK_IMPORTED_MODULE_1__.ToastNotificationService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_8__.TitleCasePipe), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__.MAT_DIALOG_DATA), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](src_app_core_services_empleaveservice_service__WEBPACK_IMPORTED_MODULE_2__.EmpleaveserviceService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](src_app_core_services_product_service__WEBPACK_IMPORTED_MODULE_3__.ProductService));
      };

      _EditLeaveemployeeComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
        type: _EditLeaveemployeeComponent,
        selectors: [["app-edit-leaveemployee"]],
        decls: 71,
        vars: 17,
        consts: [[1, "modal-header", "flex", "d-flex", "flex-row", "pt-0", 2, "justify-content", "center", "align-items", "center"], [1, "modal-title", "mb-0", 2, "color", "#EB8B3F", "font-weight", "bolder"], [1, "flex", "d-flex", "flex-row", 2, "margin-left", "auto"], ["type", "button", 1, "btn", "btn-cancel", 2, "margin-right", "10px !important", 3, "click"], ["type", "button", 1, "btn", "btn-save", 3, "click"], [1, "modal-body"], [1, "container-fluid", "px-2"], [3, "formGroup"], [1, "row"], [1, "col-lg-6", "col-md-6", "col-xl-6", "col-sm-6"], [1, "form-label"], [1, "error-asterisk"], ["appearance", "outline", 1, "example-full-width"], ["matInput", "", "placeholder", "Reason for Leave", "formControlName", "reasonleave", "required", "", "autocomplete", "off"], ["class", "text-danger", 4, "ngIf"], ["matNativeControl", "", "disableOptionCentering", "", "required", "", "placeholder", "Type", "formControlName", "type"], ["value", "Sick Leave", 4, "ngIf"], ["value", "Privilage Leave", 4, "ngIf"], ["value", "Casual Leave", 4, "ngIf"], ["value", "Compensatory Leave", 4, "ngIf"], ["matInput", "", "required", "", "ngModel", "", "bsDatepicker", "", "placeholder", "DD MMM YYYY", "id", "datePicker", "bsDatepicker", "", "formControlName", "leaveStartDate", "autocomplete", "off", 2, "text-transform", "uppercase!important", 3, "minDate", "bsConfig", "click"], [1, "iconcalender", "p-1"], ["matInput", "", "required", "", "ngModel", "", "bsDatepicker", "", "placeholder", "DD MMM YYYY", "id", "datePicker", "bsDatepicker", "", "formControlName", "leaveEndDate", "autocomplete", "off", 2, "text-transform", "uppercase!important", 3, "minDate", "bsConfig", "click"], ["matNativeControl", "", "disableOptionCentering", "", "required", "", "placeholder", "Type", "formControlName", "day"], [3, "value", 4, "ngFor", "ngForOf"], [1, "col-md-12", "col-xl-12", "col-lg-12", "col-sm-12"], ["type", "file", "accept", ".jpeg, .jpg, .png, .pdf", 3, "change"], [1, "text-danger"], ["value", "Sick Leave"], ["value", "Privilage Leave"], ["value", "Casual Leave"], ["value", "Compensatory Leave"], [3, "value"]],
        template: function EditLeaveemployeeComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function EditLeaveemployeeComponent_Template_button_click_4_listener() {
              return ctx.cancel();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function EditLeaveemployeeComponent_Template_button_click_6_listener() {
              return ctx.UpdateLeave();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function EditLeaveemployeeComponent_Template_input_click_39_listener() {
              return ctx.openDatepickerstart();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function EditLeaveemployeeComponent_Template_input_click_50_listener() {
              return ctx.openDatepickerend();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("change", function EditLeaveemployeeComponent_Template_input_change_70_listener($event) {
              return ctx.documentChange($event);
            });
        ...
        directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["ɵNgNoValidate"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__.NgControlStatusGroup, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormGroupDirective, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_9__.MatFormField, _angular_material_input__WEBPACK_IMPORTED_MODULE_10__.MatInput, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormControlName, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.RequiredValidator, _angular_common__WEBPACK_IMPORTED_MODULE_8__.NgIf, _angular_material_select__WEBPACK_IMPORTED_MODULE_11__.MatSelect, ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_12__.BsDatepickerInputDirective, ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_12__.BsDatepickerDirective, _angular_material_icon__WEBPACK_IMPORTED_MODULE_13__.MatIcon, _angular_common__WEBPACK_IMPORTED_MODULE_8__.NgForOf, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_9__.MatError, _angular_material_core__WEBPACK_IMPORTED_MODULE_14__.MatOption],
        styles: [".modal-header[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n}\n\n.modal-body[_ngcontent-%COMP%] {\n  height: calc(100% - 125px);\n  overflow-y: auto;\n}\n\n.iconcalender[_ngcontent-%COMP%] {\n  float: right !important;\n  margin-top: -25px !important;\n  margin-right: 7px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
      });
      /***/
    },
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "EmployeeLeaveRoutingModule": function EmployeeLeaveRoutingModule() {
          return (
            /* binding */
            _EmployeeLeaveRoutingModule
          );
        }
        /* harmony export */
      ...
      var _mainleave_employee_mainleave_employee_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./mainleave-employee/mainleave-employee.component */
      76183);
      /* harmony import */


      var _leave_employee_leave_employee_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./leave-employee/leave-employee.component */
      23384);
      /* harmony import */
      ...
      var _EmployeeLeaveRoutingModule = /*#__PURE__*/_createClass(function _EmployeeLeaveRoutingModule() {
        _classCallCheck(this, _EmployeeLeaveRoutingModule);
      });

      _EmployeeLeaveRoutingModule.ɵfac = function EmployeeLeaveRoutingModule_Factory(t) {
        return new (t || _EmployeeLeaveRoutingModule)();
      };

      _EmployeeLeaveRoutingModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: _EmployeeLeaveRoutingModule
      });
      _EmployeeLeaveRoutingModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](_EmployeeLeaveRoutingModule, {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "EmployeeLeaveModule": function EmployeeLeaveModule() {
          return (
            /* binding */
            _EmployeeLeaveModule
          );
        }
        /* harmony export */
      ...
      var _employee_leave_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./employee-leave-routing.module */
      42100);
      /* harmony import */
      ...
      var _mainleave_employee_mainleave_employee_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./mainleave-employee/mainleave-employee.component */
      76183);
      /* harmony import */


      var _add_leaveemployee_add_leaveemployee_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./add-leaveemployee/add-leaveemployee.component */
      9108);
      /* harmony import */


      var _edit_leaveemployee_edit_leaveemployee_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./edit-leaveemployee/edit-leaveemployee.component */
      46485);
      /* harmony import */
      ...
      var _EmployeeLeaveModule = /*#__PURE__*/_createClass(function _EmployeeLeaveModule() {
        _classCallCheck(this, _EmployeeLeaveModule);
      });

      _EmployeeLeaveModule.ɵfac = function EmployeeLeaveModule_Factory(t) {
        return new (t || _EmployeeLeaveModule)();
      };

      _EmployeeLeaveModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineNgModule"]({
        type: _EmployeeLeaveModule
      });
      _EmployeeLeaveModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_7__.CommonModule, _employee_leave_routing_module__WEBPACK_IMPORTED_MODULE_0__.EmployeeLeaveRoutingModule, _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouterModule, src_app_material_module__WEBPACK_IMPORTED_MODULE_5__.MaterialExampleModule, _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_9__.ReactiveFormsModule, ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_10__.BsDatepickerModule.forRoot()]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵsetNgModuleScope"](_EmployeeLeaveModule, {
          declarations: [_leave_employee_leave_employee_component__WEBPACK_IMPORTED_MODULE_1__.LeaveEmployeeComponent, _mainleave_employee_mainleave_employee_component__WEBPACK_IMPORTED_MODULE_2__.MainleaveEmployeeComponent, _add_leaveemployee_add_leaveemployee_component__WEBPACK_IMPORTED_MODULE_3__.AddLeaveemployeeComponent, _edit_leaveemployee_edit_leaveemployee_component__WEBPACK_IMPORTED_MODULE_4__.EditLeaveemployeeComponent],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.CommonModule, _employee_leave_routing_module__WEBPACK_IMPORTED_MODULE_0__.EmployeeLeaveRoutingModule, _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouterModule, src_app_material_module__WEBPACK_IMPORTED_MODULE_5__.MaterialExampleModule, _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_9__.ReactiveFormsModule, ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_10__.BsDatepickerModule]
        });
      })();
      /***/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "LeaveEmployeeComponent": function LeaveEmployeeComponent() {
          return (
            /* binding */
            _LeaveEmployeeComponent
          );
        }
        /* harmony export */
      ...
      var _edit_leaveemployee_edit_leaveemployee_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ../edit-leaveemployee/edit-leaveemployee.component */
      46485);
      /* harmony import */


      var _add_leaveemployee_add_leaveemployee_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../add-leaveemployee/add-leaveemployee.component */
      9108);
      /* harmony import */
      ...
      function LeaveEmployeeComponent_tr_93_td_15_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function LeaveEmployeeComponent_tr_93_td_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "td", 51);
      ...
      function LeaveEmployeeComponent_tr_93_td_17_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function LeaveEmployeeComponent_tr_93_button_20_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function LeaveEmployeeComponent_tr_93_button_20_Template_button_click_0_listener() {
            ...
            return ctx_r8.openEditLeave(item_r2.id, ctx_r8.userId);
          });
      ...
      function LeaveEmployeeComponent_tr_93_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function LeaveEmployeeComponent_tbody_94_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _LeaveEmployeeComponent = /*#__PURE__*/function () {
        function _LeaveEmployeeComponent(dialog, leaveservice, rolesPermissionsService, titleCasePipe, toastService) {
          _classCallCheck(this, _LeaveEmployeeComponent);
        ...
        _createClass(_LeaveEmployeeComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this16 = this;
            ...
            this.getleaveDetailsdays();
            this.getleaveDetails(); //this.getleaveDays();

            this.leaveservice.leaveAdded$.subscribe(function () {
              // Fetch the updated list of users
              _this16.getleaveDetails();
            });
          }
        }, {
          ...
          key: "getleaveDetails",
          value: function getleaveDetails() {
            var _this18 = this;

            this.leaveservice.getAllLeaveDetails({}, this.currentEmployee.id).then(function (res) {
          ...
          value: function getleaveDetailsdays() {
            ...
            this.leaveservice.getAllLeaveDetails1({}, this.currentEmployee.id).then(function (res) {
              console.log("res days Assign", res);
              _this19.totalLeavesAvailable = res.data.totalLeavesAvailable;
              console.log("this.totalLeavesAvailable", _this19.totalLeavesAvailable);
              _this19.totalLeavesTakenCombined = res.data.totalLeavesTakenCombined;
              console.log("this.totalLeavesTakenCombined", _this19.totalLeavesTakenCombined);
              _this19.sickleavedata = res.data.totalLeaveTaken["Sick Leave"];
              _this19.casualleavedata = res.data.totalLeaveTaken["Casual Leave"];
              _this19.privilageleavedata = res.data.totalLeaveTaken["Privilage Leave"];
              _this19.compensatoryleavedata = res.data.totalLeaveTaken["Compensatory Leave"];
          ...
          key: "openAddLeave",
          value: function openAddLeave(userId) {
            var dialogRef = this.dialog.open(_add_leaveemployee_add_leaveemployee_component__WEBPACK_IMPORTED_MODULE_1__.AddLeaveemployeeComponent, {
              width: '700px',
              height: '730px',
              data: {
                userId: userId
          ...
          key: "openEditLeave",
          value: function openEditLeave(leaveId, userId) {
            var dialogRef = this.dialog.open(_edit_leaveemployee_edit_leaveemployee_component__WEBPACK_IMPORTED_MODULE_0__.EditLeaveemployeeComponent, {
              width: '700px',
              height: '730px',
              data: {
                leaveId: leaveId,
          ...
          key: "getleaveId",
          value: function getleaveId(leaveId) {
            this.leaveId = leaveId;
          }
        }, {
          key: "deletleaveById",
          value: function deletleaveById() {
            var _this20 = this;
      ...
      _LeaveEmployeeComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        ...
        template: function LeaveEmployeeComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function LeaveEmployeeComponent_Template_button_click_65_listener() {
              return ctx.openAddLeave(ctx.userId);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function LeaveEmployeeComponent_Template_a_click_109_listener() {
              return ctx.deletleaveById();
            });
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"]("\xA0\xA0", ctx.totalLeavesAvailable, "");

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](6);

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"]("\xA0\xA0", ctx.totalLeavesTakenCombined, "");

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](6);

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"]("\xA0\xA0", ctx.thismonth ? ctx.thismonth : 0, "");
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "MainleaveEmployeeComponent": function MainleaveEmployeeComponent() {
          return (
            /* binding */
            _MainleaveEmployeeComponent
          );
        }
        /* harmony export */
      ...
      var _MainleaveEmployeeComponent = /*#__PURE__*/function () {
        function _MainleaveEmployeeComponent() {
          _classCallCheck(this, _MainleaveEmployeeComponent);
        }

        _createClass(_MainleaveEmployeeComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);

        return _MainleaveEmployeeComponent;
      }();

      _MainleaveEmployeeComponent.ɵfac = function MainleaveEmployeeComponent_Factory(t) {
        return new (t || _MainleaveEmployeeComponent)();
      };

      _MainleaveEmployeeComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: _MainleaveEmployeeComponent,
        selectors: [["app-mainleave-employee"]],
        decls: 11,
        vars: 0,
        consts: [[1, "container-fluid", "bg-white", "p-4"], [1, "row", "mt-2"], [1, "col-xxl-12", "col-xl-12", "col-lg-12", "col-md-12", "col-sm-12"], [1, "row", "mt-3", "page-nav-link"], ["id", "productlistLink", 1, "links", "col-xxl-1", "col-xl-1", "col-lg-2", "col-md-3", "col-sm-4", "col-xs-4"], ["routerLink", "./emp-leave", "routerLinkActive", "active", 1, "mt-3", "pb-1", "text-nowrap", "productLink"], [1, "col-xxl-9", "col-xl-9", "col-lg-9", "col-md-3", "col-sm-0", "col-xs-0"], [1, "mt-1"]],
        template: function MainleaveEmployeeComponent_Template(rf, ctx) {
          if (rf & 1) {
...
//# sourceMappingURL=src_app_pages_employee-leave_employee-leave_module_ts-es5.js.map